...
export default function ActivityLogs() {
  ...
  const table = tableMap['ActivityLogs'];
  ...
  return (
    <div className="p-6 pb-24 max-w-[1600px] mx-auto flex flex-col gap-6">
      <div>
        <h1 className="font-headline-xl text-on-surface mb-1">ActivityLogs</h1>
        <p className="font-body-sm text-on-surface-variant">Manage ActivityLogs data.</p>
      </div>
      <div className="card-bg rounded-xl border border-outline-variant p-6">
        {loading ? (
          ...
          <div className="text-center py-10 text-on-surface-variant/50">No ActivityLogs data found.</div>
        ) : (
